...
3. Install PyTorch 2.7 and related code
   ...
   pip install torch-runstats torch-ema torch-dftd pillow==9.3.0 opt_einsum_fx tensorboard nequip e3nn ase pymatgen numpy==1.25.2 seekpath mpi4py
   ```

4. Install HamGNN code:
   ```bash
...
1. **Edit configuration file**: Create a `band_cal.yaml` file, specifying the following parameters:
    ...
    kpath_file: "KPATH.in" # KPATH.in generated by Atomkit
    ```
2. **Run calculation**:
   ```bash
